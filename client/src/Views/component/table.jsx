...
export default class PatientDetail extends Component {
   ...
   deleteRow(id){
    ...
    //    fetch(`/patients/${id}`)
    //   .then(res => res.json())
    //   .then(NewPat =>this.setState({NewPat}))
    //        .then(result =>this.showDetail(result) )      

      return  <Redirect  to="/dashboard/patients/about" />
    }
    ...
    render() {
        ...
        const columns = [
            ...
            { Header: "Full Name", accessor: "name", width: 200, maxWidth: 200, minWidth: 200, style: { textAlign: "center" } },
            ...
            {Header:"Actions" ,Cell: props =>{
                return(
                    <Button
                        ...
                        onSubmit={() => {
                              this.deleteRow(props.original.nhisid)
                        }}
                    >View</Button>
                
                )
            }, style: { textAlign: "center" }, width: 75, maxWidth: 75, minWidth: 75}
